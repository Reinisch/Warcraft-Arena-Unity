...
namespace Core
{
    public static class UnitHelper
    {
        ...
        public const int AttackDisplayDelay = 200; // delay time next attack to prevent client attack animation problems
        ...
        public static uint UnitActionButtonAction(uint button) { return button & 0x00FFFFFF; }
        public static uint UnitActionButtonType(uint button) { return button & 0xFF000000; }
        public static uint MakeUnitActionButton(uint action, uint type) { return action | (type << 24); }
        public const int MaxUnitActionBarIndex = ActionBarIndex.End - ActionBarIndex.Start;
    }
}
...
namespace Core
{
    public static class EntityFieldHelper
    {
        ...
        public static bool IsType(this EntityType entityTypeId, EntityTypeMask typeMask)
        {
            return ((int)typeMask & (int)entityTypeId) != 0;
        }


        public static EntityFields StatField(this Stats stats)
        {
            switch (stats)
            {
                case Stats.Strength:
                ...
                default:
                    throw new NotImplementedException("EntityField for stat: " + stats + " is not implemented yet!");
            }
        }
        public static EntityFields StatPositiveField(this Stats stats)
        {
            switch (stats)
            {
                case Stats.Strength:
                ...
                default:
                    throw new NotImplementedException("EntityField for positive stat: " + stats + " is not implemented yet!");
            }
        }
        public static EntityFields StatNegativeField(this Stats stats)
        {
            switch (stats)
            {
                case Stats.Strength:
                ...
                default:
                    throw new NotImplementedException("EntityField for negative stat: " + stats + " is not implemented yet!");
            }
        }
    ...
    public struct EntityFieldsEqualityComparer : IEqualityComparer<EntityFields>
    {

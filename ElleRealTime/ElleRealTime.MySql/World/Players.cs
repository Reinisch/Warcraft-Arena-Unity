...
namespace ElleRealTime.MySql.World
{
    public class Players : ElleRealTimeDbDAO, IPlayers
    {
        ...
        public PlayerInfo[] GetPlayersInfo(PlayersInfoFilter filter, DbTransaction trans)
        {
            ...
            return ExecuteViewArray<PlayerInfo>(ElleRealTimeBaseDAO.Base.World.Players.GetBaseQueryPlayersInfo(filter, prms) + filter.OrderByCondition() +
